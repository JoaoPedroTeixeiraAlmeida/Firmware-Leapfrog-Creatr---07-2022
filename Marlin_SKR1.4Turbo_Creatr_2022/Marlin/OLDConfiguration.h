...
#define STRING_CONFIG_H_AUTHOR "(Maxxi, SKRv1.4 Turbo - Leapfrog Creatr Dual)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Leapfrog Creatr V1"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 133.32, 133.32, 1280, 104.6, 104.6}
...
#define DEFAULT_MAX_FEEDRATE          {600, 600, 200, 45, 45}    // (mm/sec) 
...
#define DEFAULT_MAX_ACCELERATION      {3000, 3000, 1000, 10000, 10000}    // X, Y, Z, E maximum start speed for accelerated moves. 
